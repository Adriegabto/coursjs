document.addEventListener("DOMContentLoaded",(e)=>{ // la méthode de chargement du document
    ...
    //on ajoute le nouvel element a l'article
    article_parent.appendChild(new_element).innerHTML = `suivre le lien <a href ="#">Item</a>`
